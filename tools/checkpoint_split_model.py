...
def _vocab_size_with_padding(orig_vocab_size, make_vocab_size_divisible_by=128,tensor_model_parallel_size=8):
...
def split_megatron_models(args):
    ...
    megatron_args.padded_vocab_size = _vocab_size_with_padding(word_embeddings.shape[0],128,split_tp_size)
