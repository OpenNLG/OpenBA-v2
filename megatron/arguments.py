...
def _add_checkpointing_args(parser):
    ...
    group.add_argument('--exit-on-missing-checkpoint', action='store_true',
                       ...
                       "initialization.")
    group.add_argument('--objectives', type=str, default="UL2",help="pretraining objectives")
...
def _add_prune_args(parser):
    group = parser.add_argument_group(title="vision")
    group.add_argument('--is_prune', type=bool, required=False, default=False,
                       help='whether or not to prune')
    ...
    group.add_argument('--drop_encoder_layers',type=str, default=None,
                       help='numbers of the dropped encoder layers, start from 0')
    group.add_argument('--drop_decoder_layers',type=str, default=None,
                       help='numbers of the dropped decoder layers, start from 0')
    group.add_argument('--target_loss',type=list, default=[1.154,1.594,2.106,1.298,1.723,2.151,2.151],
                       help='the target loss for dynamic batch loading')
    group.add_argument('--dynamic_batch_loading',action='store_true')
    group.add_argument('--current_prop',type=list, default=[0.02, 0.02, 0.8, 0.1, 0.02, 0.02, 0.02])
    group.add_argument('--dynamic_prop',type=list, default=[0.02, 0.02, 0.8, 0.1, 0.02, 0.02, 0.02])
    return parser